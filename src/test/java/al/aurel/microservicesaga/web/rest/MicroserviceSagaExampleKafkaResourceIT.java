package al.aurel.microservicesaga.web.rest;
...
import al.aurel.microservicesaga.config.KafkaProperties;
...
class MicroserviceSagaExampleKafkaResourceIT {
    ...
    void setup() {
        ...
        MicroserviceSagaExampleKafkaResource kafkaResource = new MicroserviceSagaExampleKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/microservice-saga-example-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/microservice-saga-example-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
