...
@RestController
@RequestMapping("/api/microservice-saga-example-kafka")
public class MicroserviceSagaExampleKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MicroserviceSagaExampleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroserviceSagaExampleKafkaResource(KafkaProperties kafkaProperties) {
