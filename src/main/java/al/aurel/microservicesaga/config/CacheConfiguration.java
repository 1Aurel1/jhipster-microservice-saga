package al.aurel.microservicesaga.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("microserviceSagaExample");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("microserviceSagaExample");
        ...
        config.getMapConfigs().put("al.aurel.microservicesaga.domain.*", initializeDomainMapConfig(jHipsterProperties));
